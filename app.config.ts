...
const EAS_PROJECT_ID = "13427ce7-f306-4e2d-b332-0a2cc67541ca";
const PROJECT_SLUG = "twitter-clone";
const OWNER = "aurenix3";
 
// Production конфігурація (базова)
const APP_NAME = "Twitter Clone";
const BUNDLE_IDENTIFIER = "com.aurenix3.twitterclone";
const PACKAGE_NAME = "com.aurenix3.twitterclone";
const SCHEME = "twitter-clone";
